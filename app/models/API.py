...
def showPrice(name):
    ...
    if name == "laptop":
        results = json.load(urllib.urlopen("http://www.pricetree.com/dev/api.ashx?pricetreeId=123051&apikey=7770AD31-382F-4D32-8C36-3743C0271699"))
    if name == "tv":
        results = json.load(urllib.urlopen("http://www.pricetree.com/dev/api.ashx?pricetreeId=119326&apikey=7770AD31-382F-4D32-8C36-3743C0271699"))
    if name == "printer":
    ...
    if name == "wash":
        results = json.load(urllib.urlopen("http://www.pricetree.com/dev/api.ashx?pricetreeId=122678&apikey=7770AD31-382F-4D32-8C36-3743C0271699"))
    return results["data"];
